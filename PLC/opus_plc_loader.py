...
class PLCLoader_energy(Sequence):
    ...
    def __getitem__(self, index):
        ...
        out_features = np.concatenate([features[:,:,:], 1.-out_lost], axis=-1)
...
class PLCLoader_shape(Sequence):
    ...
    def __init__(self, features_mdct_smooth, features_E, seq_size,batch_size,choice = 0,lost = 0):
        self.batch_size = batch_size
